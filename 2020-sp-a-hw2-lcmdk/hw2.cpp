...
int main()
{
  ...
  handle = (static_cast<float>(stink)/thresh_score) * (3*tail + wt_possum);
  handle = handle  + 30*(stink/baro_press);
  ...
  cout << "Based off of the information given!" << endl;
  ...
  cout << "Have a good day and go get that 'possum!" << endl;
